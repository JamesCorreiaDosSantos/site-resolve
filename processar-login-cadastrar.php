...
$valorEmail = $_POST['cadastroEmail'];

$valorEmailBD = $db->get($valorEmail);

if($valorEmailBD == null){
$idEmailCadastro = $_POST['cadastroEmail'];
$senhaCadastro = $_POST['cadastroSenha'];
$db->set($idEmailCadastro, $senhaCadastro);

  echo '<script>';
  echo 'function minhaFuncaoJS() {';
  echo '    alert("Parabéns, cadastrado com sucesso");';
  ...
  echo '<script>';
  echo 'function minhaFuncaoJS() {';
  echo '    alert("Este email ja tem cadastrado, tente novamente");';
  echo '}';
  echo '</script>';
}
